import imgProject from '../../assets/img/trast.png'
import React from 'react'
import { Badge } from "react-bootstrap";
import { Link } from "react-router-dom";

export default function TrastPro() {
    return(
        <div className="project-items">
            ...
            <div className="box-body">
                ...
                <p>
                Web based application aimed for managing and communicate request between tech department and other department in Tokocrypto. 
